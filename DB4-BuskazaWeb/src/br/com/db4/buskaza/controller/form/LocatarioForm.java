...
public class LocatarioForm extends ActionForm {
	...
	private Locatario locatarioEntity;
	...
	public Locatario getLocatarioEntity() {
		return locatarioEntity;
	}

	public void setLocatarioEntity(Locatario locatarioEntity) {
		this.locatarioEntity = locatarioEntity;
	}
	...
	public LocatarioForm() {
		locatarioEntity = new Locatario();
		locatarioEntity.setBanco(new Banco());
		locatarioEntity.setEndereco(new Endereco());
		locatarioEntity.getEndereco().setEstado(new Estado());
	}
