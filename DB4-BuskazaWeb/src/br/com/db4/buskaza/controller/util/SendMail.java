...
public class SendMail {  
	...
	ResourceBundle resourceConfig = ResourceBundle.getBundle("ApplicationResources");
	
    private String mailSMTPServer;  
    private String mailSMTPServerPort;  
    
    private String user		=	resourceConfig.getString("smtp.user").trim();
    private String password = 	resourceConfig.getString("smtp.password").trim();
    ...
    public SendMail() { //Para o GMAIL   
    	...
    	mailSMTPServer 		= resourceConfig.getString("smtp.host").trim();
    	mailSMTPServerPort 	= resourceConfig.getString("smtp.port").trim();  
