...
public interface Constants {
	...
	public static final String MENSAGEM_ERRO_CPFCNPJ_EXISTENTE = "message.erro.cpfcnpj.existente";

	public static final String MENSAGEM_ERRO_EMAIL_EXISTENTE = "message.erro.email.existente";

	public static final String USUARIO_SESSAO = "usuario";

	public static final String ADMIN_SESSAO = "usuario_admin";
	...
	public static final String ORIGEM_REQUEST = "ORIGEM_REQUEST";

	public static final String _RESERVA = "_RESERVA";
