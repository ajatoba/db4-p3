...
<div class="MyriadProRegular">
  <div class="form_01">
  	<table border="0" align="center" cellpadding="0" cellspacing="2" class="txt_form">
    	...
    	<tr>
      		<td height="30">
      			<html:text property="municipio" styleId="municipio" size="195" style="width:205px"  styleClass="MyriadProRegular" />	
      		</td>
      		<td height="30" colspan="2" id="busca_estado">         	      	
				<html:select property="imovelEntity.estado.codigo" styleId="sigla" style="width:188x" styleClass="MyriadProRegular"> 
		...
		</table><!-- Final Table Pa�s, Quarto, �rea, Capacidade -->
	</td>
</tr>
<tr>
	<td colspan="3">
