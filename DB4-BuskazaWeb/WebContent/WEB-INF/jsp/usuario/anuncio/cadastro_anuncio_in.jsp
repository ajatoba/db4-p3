	...
	<table width="100%" border="0">
	  ...
	  <tr>  	
        ...
        <!-- LEGENDA -->
      	...
      	Tarifa Diária: <html:text property="tarifaDiaria" styleClass="number,MyriadProRegular" styleId="tarifaDiaria" maxlength="10" size="70"/><br/>
      	Tarifa Semanal: <html:text property="tarifaSemanal" styleClass="number,MyriadProRegular" styleId="tarifaSemanal" maxlength="10" size="70"/><br/>
      	Tarifa Mensal: <html:text property="tarifaMensal" styleClass="number,MyriadProRegular" styleId="tarifaMensal" maxlength="10" size="70"/><br/>
      	Tarifa Quinzenal: <html:text property="tarifaQuinzenal" styleClass="number,MyriadProRegular" styleId="tarifaQuinzenal" maxlength="10" size="70"/><br/>
		Pacote Fechado: <html:text property="tarifaPacoteFechado" styleClass="number,MyriadProRegular" styleId="tarifaPacote" maxlength="10" size="70"/><br/>      	
      	<br>
			      	...
			      	<table cellspacing="10" border="0">
			      		<tr>
				      		<td valign="top">
				      			...
				      			<table width="100%" border="0">
				                <tr>
				                  <td colspan="3" class="tit_box_facil_alugar">Pagamento integral da estadia (só para proprietários Brasileiros).</td>
				                </tr>
				                <tr>
				                ...
				                <tr>
				                  <td colspan="2"><span class="txt_caracteristicas"><input type="text" name="nomeTitularConta" value="${usuario.nomeTitularConta}" size="300" /></span></td>
				                  <td><span class="txt_caracteristicas"><input type="text" name="cpfTitularConta" value="${usuario.cpfTitularConta}" size="150" /></span></td>
				                </tr>
				                <tr>
				                ...
				                <tr>
				                  <td><span class="txt_caracteristicas"><input type="text" name="codigoBanco" value="${usuario.codigoBanco}" size="70"/></span></td>
				                  <td><span class="txt_caracteristicas"><input type="text" name="agencia" value="${usuario.agencia}" size="70"/></td>
				                  <td><span class="txt_caracteristicas"><input type="text" name="conta" value="${usuario.contaCorrente}" size="70"/></span></td>
				                </tr>
				              </table>
