...
<div id="cont_cadastro">
  ...
  <div id="formulario_cadastro">
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/buzkaza/teaser/_img/bullet_cadastro.jpg" width="22" height="13" /><span class="MyriadProSemiboldIt">Informa��es do propriet�rio</span><br />
      <br />
    </p>
	...
	<html:form method="post" styleId="locadorForm" action="/locador?act=incluirLocador">
      <div>
        <table width="95%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <td width="58%" class="MyriadProRegular">Nome Completo / Raz�o Social</td>
      ...
      <div>
        <div id="bg_criar_user">
          <div class="alinha_table">
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="16%" rowspan="2" class="MyriadProSemiboldIt">Criar usu�rio &gt;</td>
      ...
      <div class="end_correspondencia"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/buzkaza/teaser/_img/bullet_cadastro.jpg" width="22" height="13" /><span class="MyriadProSemiboldIt">Endere�o para correspond�ncia</span> <br />
        <br />
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <div class="planos_adesao">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><div><html:checkbox property="locadorEntity.recebeInfo" styleClass="MyriadProRegular"/></div><div style=" float:left; width:500px; margin-top:7px; margin-left:3px;"><span class="MyriadPro14">Desejo receber informa��es  deste site no meu email</span></div></td>
          </tr>
          <tr>
            <td><div><html:checkbox property="locadorEntity.leuCondicoes" styleClass="MyriadProRegular"/></div><div style=" float:left; width:500px; margin-top:7px; margin-left:3px;"><span class="MyriadPro14">Li e aceito os termos e condi��es deste site</span></div></td>
          </tr>
        </table>
      </div>
